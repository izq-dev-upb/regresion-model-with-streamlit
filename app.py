...
Original file is located at
    https://colab.research.google.com/drive/1nsB-5bc6nHbdzJfIUZbJcc8l-8_lG3bm
...
st.warning("El modelo tiene un error del 5.2% (mape: error porcentual)")
